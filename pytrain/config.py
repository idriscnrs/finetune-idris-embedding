...
class DataConfig(Config):
    ...
    data_dir: Path = field(
        default=Path.cwd() / "./idris_doc_pairs_dataset",
        metadata={"converter": Path, "export": False, "kwargs": True}
    )
    train_csv_name: str = field(
        default="pairs_dataset.csv",
        metadata={"converter": str, "export": True, "kwargs": True}
    )
    valid_csv_name: str = field(
        default="val_pairs_dataset.csv",
        metadata={"converter": str, "export": True, "kwargs": True}
    )
    batch_size: int = field(
        default=4, metadata={"converter": int, "export": True, "kwargs": True}
    )
    keep_faqs: bool = field(
        default=False, metadata={"converter": bool, "export": True, "kwargs": True}
    )
    tresh_ground: int = field(
        default=0, metadata={"converter": int, "export": True, "kwargs": True}
    )
    tresh_rel: int = field(
        default=0, metadata={"converter": int, "export": True, "kwargs": True}
    )
    tresh_stand: int = field(
        default=0, metadata={"converter": int, "export": True, "kwargs": True}
    )
...
class GlobalConfig(Config):
    ...
    data_config: DataConfig = field(
        default_factory=lambda: DataConfig(sub_config=True),
        metadata={"export": True}
    )
